...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_module__ = __webpack_require__(369);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dao_dao_util__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_api_const__ = __webpack_require__(367);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_file_upload__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__environments_environment__ = __webpack_require__(225);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        __WEBPACK_IMPORTED_MODULE_2__api_api_const__["a" /* API */].setProductMode(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].production);
    ...
    AppComponent.prototype.config = function (i, name) {
        var self = this;
    ...
    AppComponent.prototype.loadServers = function (delay, i) {
        var _this = this;
        var self = this;
        if (i !== null) {
            this.doing[i] = true;
    ...
    AppComponent.prototype.deploy = function (i, name) {
        var _this = this;
        var self = this;
        this.dao.get(__WEBPACK_IMPORTED_MODULE_2__api_api_const__["a" /* API */].getAPI("server/manipulation")('deploy', name))
            ...
            .subscribe(function (ret) {
            if (20000 === ret.code) {
                _this.loadServers(3, i);
            }
        }, function (error) { return __WEBPACK_IMPORTED_MODULE_1__dao_dao_util__["a" /* DaoUtil */].logError(error); });
    };
    AppComponent.prototype.start = function (i, name) {
        var _this = this;
        var self = this;
        this.dao.get(__WEBPACK_IMPORTED_MODULE_2__api_api_const__["a" /* API */].getAPI("server/manipulation")('start', name))
            ...
            .subscribe(function (ret) {
            if (20000 === ret.code) {
                _this.loadServers(6, i);
            }
        }, function (error) { return __WEBPACK_IMPORTED_MODULE_1__dao_dao_util__["a" /* DaoUtil */].logError(error); });
    };
    AppComponent.prototype.stop = function (i, name) {
        var _this = this;
        var self = this;
    ...
    AppComponent.prototype.restart = function (i, name) {
        var _this = this;
        var self = this;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_http__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
